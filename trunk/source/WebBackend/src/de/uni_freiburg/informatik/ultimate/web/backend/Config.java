...
/**
 * Back-end settings. Can load settings from config.properties file.
 *
 */
public class Config {
	...
	public static void load() {
		try {
			final Properties appSettings = new Properties();
			final FileInputStream fileInputStream = new FileInputStream("web.config.properties");
